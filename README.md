...
Что реализовано: регистрация, генерация и проверка OTP-кода (срок действия 5 минут, один активный код на пользователя), подтверждение email, повторный вход, обработка ошибок 400 и 404.

Что пока не реализовано: выдача JWT-токена в /auth/confirm, проверка токена в /auth/me, инвалидация токена в /auth/logout, реальная отправка email.
